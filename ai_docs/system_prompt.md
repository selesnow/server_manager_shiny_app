...
Ключ шифрования необходимо установить только 1 раз, после чего он записывается в хранилище учётных данных Windows, и при необходимости считывается от туда.
