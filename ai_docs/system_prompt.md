...
## Поиск нужной задачи
Фунция `get_tasks()` позволяет запросить таблицу со всеми данными задачам настроенным в планировщике заданий, используй её для поиска нужных задач по описанию и прочим параметрам. 
...
Отлельно у тебя есть функция `get_failed_tasks()` которая позволяет быстро получить список задачь, работа которых была завершена ошибкой.
