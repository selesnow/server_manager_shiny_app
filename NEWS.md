...
### Added
* Доработана вкладка **Логи**: 
  * Добавлена возможность группировки данных по дням, неделям и месяцам.
  * Добавлен график по количеству уникальных пользователей по дням.
  * Добавлен график по активности пользователей по дням недели и времени суток.
  * Добавлена общая таблица со статистикой по периодам.
