...
На вкладку **Статистика** добавлена таблица с анализом наличия элементов проекта (README, NEWS, Git, Rproj) в разрезе авторов.

## v1.22.2 - 2025-08-21

### Added

На вкладке **Задачи** в блок "Информация задаче" добавлена информация о наличие элементов проекта: README, NEWS, Git, Rproj.
