...
### Added
* На вкладке **Логи** добавлена возможность группировки данных по дням, неделям и месяцам.
* На вкладке **Логи** добавлен график по количеству уникальных пользователей по дням.
* На вкладке **Логи** добавлен график по активности пользователей по дням недели и времени суток.
* На вкладке **Логи** добавлена общая таблица со статистикой по периодам.

### Changed
* Оптимизирован процесс поиска AI Асистентом лога и скрипта запускаемого задачей.
* Оптимизировано описание функций пакета `rpup` в системном промпте AI ассистента.
* На вкладке **CMD** расширена строка ввода команды и кнопка "Выполнить".
