...
### Added
- На вкладку задачи добавлена кнопка "Код", по нажатию на которую можно посмотреть листинг кода запускаемого выбранной задачей. 
- Модель используемая в чатах и анализе Rout была дообучена:
    - Добавил больше информации про пакет n1:
        - Добавил описание статусов сотрудников
        - Добавил описание всех аргументов всех функций
    - Добавил в описание пакетов `rpup` и `n1` список названий компаний, что бы он мог правильно давать фильтры по их названиям
    - Добавлена информация по работе с python пакетом `alspy` и классом `PyPup`:
        - Добавлено описание всех методов класса
        - Добавлено описание сех аргументов всех методов
        - Добавлено описание полей возвращаемых основными методами класса
        - Добавил описание случаев когда надо использовать класс PyPup
    - В модель добавлено описание общей концепции и принципов нашей разработки.
    
### Changed
- У приложения новый favicon
- При отправке Rout файла на анализ теперь мы отдаём только 30000 последних символов лога, что бы не перегружать его черезмерным количеством информации.
