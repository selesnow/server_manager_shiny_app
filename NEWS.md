...
### Added
* Добавлено логирование всех диалогов с AI ассистентом.
* Добавлено логирование поиска по файлам.
* Вкладка **Логи** разделена на 3 дополнительные вкладки
  * Основные - тут остался прежний функционал вкладки
  * AI чат - тут можно смотреть логи всех диалогов с AI Ассистентом
  * Поиск по файлам = тут можно смотреть логи результатов поиска по файлам

### Fixed
* В приветвенное сообщение AI ассистента вернул обращение по логину пользователя.
