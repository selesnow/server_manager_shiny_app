...
### Changed
* Из общей таблицы задач на вкладке **Задачи** убраны столбцы связанные с триггерами, таким образом из таблицы задач быи убраны все дублирования задач, а информация о триггерах хранится из подтягивается из отдельной таблицы.
