  ...
  observeEvent(logged_in(), {
    if (logged_in()) {
      ...
      dev_chat$register_tool(tool(
        ...
        "Функция которая позволяет запросить задачи из Планфик (не из планировщика заданий Windows!) команды аналитиков, для анализа их спринта и успешности выполнения ими задач. По умолчанию возвращаются данные за текущий спринт.",
