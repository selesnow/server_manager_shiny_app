...
server <- function(input, output, session) {
            ...
            bslib::page_fluid(
              div(class = "stats-description",
                HTML(glue::glue(
                  ...
                  "</ul>",
                  "<Br>Так же он поможет вам в исправлении ошибок и ",
                  "понимании логики чужого кода написанного на базе внутренних пакетов.",
  ...
  observeEvent(logged_in(), {
    if (logged_in()) {
      ...
      dev_chat$register_tool(tool(
        get_tasks,
        "Получить таблицу с данными по задачам из панировщика заданий Windows. С их описанием и всеми параметрами. Эту функцию удобно использовать для поиска нужных задач по запросу пользователя."
      ))
